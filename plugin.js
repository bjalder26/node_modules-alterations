...
return string.replaceAll('\\%', '%').replaceAll('\\{', '{').replaceAll('\\}', '}').replaceAll('\\ ',' ');
  ...
  let openMathjaxEditor = function(target) {
    ...
    editor.windowManager.open({
      ...
      body: {
        ...
        items: [{
            ...
            type: 'htmlpanel',
            html: 'Examples: \\alpha \\sqrt{2} \\frac{num}{denom} He_2^{4} <div style="text-align:right"><a href="https://wikibooks.org/wiki/LaTeX/Mathematics" target="_blank" style="font-size:small">LaTex</a></div>'
          }, {
            type: 'htmlpanel',
	...
	let refreshDialogMathjax = function(latex) {
      ...
      div.innerHTML = getMathText(preLatex(latex), {start: '$$', end: '$$'});
